...
<div class="sidebar fixed top-0 bottom-0 lg:left-0 p-2 w-[300px] overflow-y-auto text-center bg-green-900">
    <div class="text-gray-100 text-xl">
        <div class="p-2.5 mt-1 flex items-center">
            <i class="bi bi-app-indicator px-2 py-1 rounded-md bg-blue-600"></i>
            <h1 class="font-bold text-gray-200 text-[15px] ml-3">Task</h1>
    ...
    <div class="text-left text-sm mt-2 w-4/5 mx-auto text-gray-200 font-bold" id="submenu">
        ...
        <a href="{{Route('listadoUsers')}}" class="block">
            <h1 class="cursor-pointer p-2 hover:bg-blue-600 rounded-md mt-1">
                Búsqueda
            </h1>
        </a>
    ...
    <a href="/logout" class="block">
        <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-blue-600 text-white">
            ...
            <span class="text-[15px] ml-4 text-gray-200 font-bold">Usuario ::</span>
